...
var HostConfig = {
  ...
  // 渲染阶段执行
  shouldSetTextContent: function shouldSetTextContent(type, props) {// console.log('shouldSetTextContent', type, typeof props.children)
...
var MP = _objectSpread(_objectSpread({}, _react["default"]), {}, {
  ...
  render: function render(reactElement, container, callback) {
    ...
    console.log(reactElement); // update the root Container
